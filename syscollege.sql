...
CREATE TABLE CURSO
(
I_CRS_ID INTEGER NOT NULL CONSTRAINT PK_I_CRS_ID PRIMARY KEY,
V_CRS_DESCRIPCION VARCHAR(50) NOT NULL,
I_CRS_ID_TRN INTERGER NOT NULL,
I_CRS_ID_PRF INTEGER NOT NULL,
I_CRS_ID_USR_CREA INTEGER NOT NULL,
D_CRS_FEC_CREA DATE NOT NULL,
I_CRS_ID_USR_ACTU INTEGER NULL,
D_CRS_FEC_ACTU DATE NULL,  
CONSTRAINT FK_I_CRS_ID_USR_CREA FOREIGN KEY (I_CUR_ID_USR_CREA) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_ID_USR_ACTU FOREIGN KEY (I_CUR_ID_USR_ACTU) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_ID_TRN FOREIGN KEY (I_CUR_ID_TRN) REFERENCES TURNO (I_TRN_ID,
CONSTRAINT FK_I_CRS_ID_PRF FOREIGN KEY (I_CUR_ID_PRF) REFERENCES PROFESOR (I_PRF_ID),
);
...
CONSTRAINT FK_I_ANU_ID_USR_CREA FOREIGN KEY (I_ANU_ID_USR_CREA) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_ANU_ID_USR_ACTU FOREIGN KEY (I_ANU_ID_USR_ACTU) REFERENCES USUARIO (I_USR_ID),
);

CREATE TABLE CURSO_GRADO
(
I_CRS_GRD_ID INTEGER NOT NULL CONSTRAINT PK_I_CRS_GRD_ID KEY,
I_CRS_GRD_ID_CRS INTEGER NOT NULL,
I_CRS_GRD_ID_GRD INTEGER NOT NULL,
I_CRS_GRD_ID_USR_CREA INTEGER NOT NULL,
D_CRS_GRD_FEC_CREA DATE NOT NULL,
I_CRS_GRD_ID_USR_ACTU INTEGER NULL,
D_CRS_GRD_FEC_ACTU DATE NULL, 
CONSTRAINT FK_I_CRS_GRD_ID_USR_CREA FOREIGN KEY (I_CRS_GRD_ID_USR_CREA) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_GRD_ID_USR_ACTU FOREIGN KEY (I_CRS_GRD_ID_USR_ACTU) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_GRD_ID_CRS FOREIGN KEY (I_CRS_GRD_ID_CRS) REFERENCES CURSO (I_CRS_ID),
CONSTRAINT FK_I_CRS_GRD_ID_GRD FOREIGN KEY (I_CRS_GRD_ID_GRD) REFERENCES GRADO (I_GRD_ID),
);

CREATE TABLE CURSO_PROFESOR
(
I_CRS_PRF_ID INTEGER NOT NULL CONSTRAINT PK_I_CRS_PRF_ID KEY,
I_CRS_PRF_ID_CRS INTEGER NOT NULL,
I_CRS_PRF_ID_PRF INTEGER NOT NULL,
I_CRS_PRF_ID_USR_CREA INTEGER NOT NULL,
D_CRS_PRF_FEC_CREA DATE NOT NULL,
I_CRS_PRF_ID_USR_ACTU INTEGER NULL,
D_CRS_PRF_FEC_ACTU DATE NULL, 
CONSTRAINT FK_I_CRS_PRF_ID_USR_CREA FOREIGN KEY (I_CRS_PRF_ID_USR_CREA) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_PRF_ID_USR_ACTU FOREIGN KEY (I_CRS_PRF_ID_USR_ACTU) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_CRS_PRF_ID_CRS FOREIGN KEY (I_CRS_PRF_ID_CRS) REFERENCES CURSO (I_CRS_ID),
CONSTRAINT FK_I_CRS_PRF_ID_PRF FOREIGN KEY (I_CRS_PRF_ID_PRF) REFERENCES PROFESOR (I_PRF_ID)
);

CREATE TABLE ANUNCIO_GRADO
(
I_ANU_GRD_ID INTEGER NOT NULL CONSTRAINT PK_I_ANU_GRD_ID KEY,
V_ANU_GRD_DESCRIPCION VARCHAR(50) NOT NULL,
I_ANU_GRD_ID_USR_CREA INTEGER NOT NULL,
D_ANU_GRD_FEC_CREA DATE NOT NUELL,
I_ANU_GRD_ID_USR_ACTU INTEGER NULL,
D_ANU_GRD_FEC_ACTU DATE NULL,
CONSTRAINT FK_I_ANU_GRD_ID_USR_CREA FOREIGN KEY (I_ANU_GRD_ID_USR_CREA) REFERENCES USUARIO (I_USR_ID),
CONSTRAINT FK_I_ANU_GRD_ID_USR_ACTU FOREIGN KEY (I_ANU_GRD_ID_USR_ACTU) REFERENCES USUARIO (I_USR_ID),
);
